...
replace YearMoved = . if YearMoved > 9995
replace WhyMoved  = . if WhyMoved  > 96
replace RaceHD = . if (RaceHD == 9)
drop BealeRaw
replace RuralUrban = . if RuralUrban > 98
replace EduHD = . if (EduHD == 99)
replace EduWF = . if (EduWF == 99)
...
save "/Users/yeabinmoon/Dropbox/Last/Data/Addition/Data/2.refine_First.dta", replace
